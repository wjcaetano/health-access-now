...
const perfil = [
  ...
  "Empreendedores com experiência em gestão",
  "Investidores interessados no setor de saúde",
  "Pessoas com network na área médica",
  "Empresários que buscam diversificar negócios"
];
              ...
              <div className="container mx-auto px-4 max-w-4xl">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-2xl">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Input 
                          id="cidade" 
                          placeholder="Qual cidade você gostaria?" 
                          required 
                          className="mt-2"
                        />
                      </div>
                  ...
                  <div className="text-center">
                    <Button
                      size="lg"
                      className="bg-white text-agendaja-primary hover:bg-agendaja-light text-xl px-12 py-6 shadow-lg"
                      onClick={() => setShowForm(true)}
                    >
